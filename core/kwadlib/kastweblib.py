...
'contents':{
    ...
    """
    Run test into python terminal (copy paste the following) :
import sys
# sys.path.append(' /opt/kastmenu/current/core')
sys.path.append('/export/softwares/MIDDLEWARE/kwad/kwad-5.5/core')
from kwadlib import apimenup
w=apimenup.digest(' /opt/kastmenu/current/samples/apimenu/menu2_follow.xml', record=False, go=None, batch=None, pause=None, noclear=False, port=1234, secid='abcd', is_listening=True, showResultingSourceOnly=False, temp_dir='/tmp', tmpl_kws={})
# w=apimenup.digest(' /opt/kastmenu/current/samples/apimenu/menu2_follow.xml', record=False, go=None, batch=None, pause=None, noclear=False, port=1234, secid='abcd', is_listening=True, showResultingSourceOnly=False, temp_dir='/tmp', tmpl_kws={})
    """
