...
Note: The kastweb interface program (kastweb.py) is only remotly run by the kastmenu-server, 
...
Genkeys will: 
    ...
    cp /etc/kastmenu-server/keys/caclients/to_kastweb/.   <kastmenu_install_dir>/keys/caclients
"""
